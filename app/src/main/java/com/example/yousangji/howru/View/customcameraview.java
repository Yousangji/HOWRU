...
/**
 * Created by YouSangJi on 2017-11-15.
 */

public class customcameraview extends SrsCameraView implements GLSurfaceView.Renderer {
    private GPUImageFilter magicFilter;
   private SurfaceTexture surfaceTexture;
   // private TextureView surfaceTexture;
   ...
   private Camera mCamera;
    ...
    //////////////////////
    private ByteBuffer byteBuffer_temp;

    private FaceDetector detector;
    private Thread thread_face;
    private final Object lockwrite = new Object();
    private ConcurrentLinkedQueue<ByteBuffer> mGLIbyteBufferCache = new ConcurrentLinkedQueue<>();
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if(detector!=null) {
            Frame frame;
            Bitmap mbitmap;
            Log.d("mytag","detector is not null");


            byteBuffer_temp = ByteBuffer.allocate(mPreviewWidth * mPreviewHeight * 4);
            frame = new Frame.Builder().setImageData(byteBuffer_temp, mPreviewWidth, mPreviewHeight, 17).build();




            // mbitmap= createBitmapFromGLSurface(0,0,mPreviewWidth,mPreviewHeight,gl);
...
*/
    ...
    public void setcallback(FaceDetector dt){
        detector=dt;

/*
        thread_face=new Thread(new Runnable() {
            @Override
            public void run() {
                while(!Thread.interrupted()){
